...
impl AesGcmDecrypt {
    ...
    pub fn decrypt(&self, base64_cipher_text: &str,  base64_key: &str) -> String{
        ...
        let nonce_byte = general_purpose::STANDARD.decode(part[0]).expect("Invalid Base64 nonce");
        let ciphertext = general_purpose::STANDARD.decode(part[1]).expect("Invalid Base64 ciphertext");
